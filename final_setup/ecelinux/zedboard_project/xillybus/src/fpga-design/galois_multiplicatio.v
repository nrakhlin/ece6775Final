...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((icmp_ln233_fu_86_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln233_fu_86_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        p_0_21_reg_77 <= select_ln239_fu_136_p3;
    end else if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        p_0_21_reg_77 <= a;
    end
end
...
always @ (*) begin
    if ((((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)) | ((icmp_ln233_fu_86_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
assign select_ln235_fu_102_p3 = ((trunc_ln233_fu_98_p1[0:0] === 1'b1) ? p_0_21_reg_77 : 8'd0);

assign select_ln239_fu_136_p3 = ((tmp_fu_122_p3[0:0] === 1'b1) ? xor_ln240_fu_130_p2 : shl_ln238_fu_116_p2);

assign shl_ln238_fu_116_p2 = p_0_21_reg_77 << 8'd1;

assign tmp_fu_122_p3 = p_0_21_reg_77[32'd7];

assign trunc_ln233_fu_98_p1 = b_assign_1_reg_68[0:0];

assign xor_ln235_fu_110_p2 = (select_ln235_fu_102_p3 ^ p_0_reg_57);

assign xor_ln240_fu_130_p2 = (shl_ln238_fu_116_p2 ^ 8'd27);

assign zext_ln241_fu_154_p1 = b_assign_fu_144_p4;
