# 1 "../../refactored/helper.cpp"
# 1 "../../refactored/helper.cpp" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 155 "<built-in>" 3
# 1 "<command line>" 1
...
# 140 "../../refactored/helper.cpp"
     ...
     EX_INNER3:
      for (i = 0; i < 4; i++)
      {
        temp = expandedKey[currentSize - size];
        expandedKey[currentSize] = temp ^ t[i];
        currentSize++;
      }
    }
}
