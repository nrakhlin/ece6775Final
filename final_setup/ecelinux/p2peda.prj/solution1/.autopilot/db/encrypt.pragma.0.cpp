# 1 "../../refactored/encrypt.cpp"
# 1 "../../refactored/encrypt.cpp" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 155 "<built-in>" 3
# 1 "<command line>" 1
...
# 4 "../../refactored/encrypt.cpp" 2
# 1 "../../refactored/encrypt.h" 1
