...
// ==============================================================
#ifndef __dut_urem_7ns_5ns_bkb__HH__
#define __dut_urem_7ns_5ns_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_urem_7ns_5ns_bkb) {
    ...
    SC_CTOR(dut_urem_7ns_5ns_bkb):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
