...
entity aes_invRound_rsbox_rom is 
    generic(
             DWIDTH     : integer := 8; 
             AWIDTH     : integer := 8; 
...
architecture rtl of aes_invRound_rsbox_rom is 
...
architecture arch of aes_invRound_rsbox is
    component aes_invRound_rsbox_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    aes_invRound_rsbox_rom_U :  component aes_invRound_rsbox_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
