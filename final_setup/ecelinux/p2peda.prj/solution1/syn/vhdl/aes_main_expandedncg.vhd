...
entity aes_main_expandedncg_rom is 
    generic(
             DWIDTH     : integer := 8; 
             AWIDTH     : integer := 8; 
...
architecture rtl of aes_main_expandedncg_rom is 
...
entity aes_main_expandedncg is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of aes_main_expandedncg is
    component aes_main_expandedncg_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    aes_main_expandedncg_rom_U :  component aes_main_expandedncg_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
