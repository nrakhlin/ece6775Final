...
architecture behav of galois_multiplicatio is 
    ...
    signal xor_ln235_fu_110_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal icmp_ln233_fu_86_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln239_fu_136_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal zext_ln241_fu_154_p1 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal xor_ln240_fu_130_p2 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((icmp_ln233_fu_86_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln233_fu_86_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
                b_assign_1_reg_68 <= zext_ln241_fu_154_p1;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln233_fu_86_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
                p_0_reg_57 <= xor_ln235_fu_110_p2;
            elsif (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, icmp_ln233_fu_86_p2)
    begin
        case ap_CS_fsm is
    ...
    ap_done_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_CS_fsm_state2, icmp_ln233_fu_86_p2)
    begin
        if ((((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1)) or ((icmp_ln233_fu_86_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2)))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state2, icmp_ln233_fu_86_p2)
    begin
        if (((icmp_ln233_fu_86_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    ap_return_assign_proc : process(ap_CS_fsm_state2, icmp_ln233_fu_86_p2, p_0_reg_57, ap_return_preg)
    begin
        if (((icmp_ln233_fu_86_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    zext_ln241_fu_154_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(b_assign_fu_144_p4),5));
end behav;
