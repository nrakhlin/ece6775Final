...
entity aes_invMain_expang8j_rom is 
    generic(
             DWIDTH     : integer := 8; 
             AWIDTH     : integer := 8; 
...
architecture rtl of aes_invMain_expang8j_rom is 
...
entity aes_invMain_expang8j is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of aes_invMain_expang8j is
    component aes_invMain_expang8j_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    aes_invMain_expang8j_rom_U :  component aes_invMain_expang8j_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
