...
architecture rtl of aes_round_sbox_rom is 
...
architecture arch of aes_round_sbox is
    component aes_round_sbox_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    aes_round_sbox_rom_U :  component aes_round_sbox_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
