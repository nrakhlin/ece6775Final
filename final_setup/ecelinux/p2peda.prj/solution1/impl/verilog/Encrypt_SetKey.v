...
wire   [0:0] icmp_ln56_fu_310_p2;
reg   [0:0] icmp_ln56_reg_456;
reg   [0:0] icmp_ln56_reg_456_pp0_iter1_reg;
...
reg   [31:0] feistel_result_reg_471;
...
reg   [31:0] ap_phi_reg_pp0_iter0_phi_ln57_reg_260;
reg    grp_feistel_fu_297_ap_start_reg;
wire    ap_CS_fsm_state6;
wire   [31:0] xor_ln65_fu_339_p2;
wire   [31:0] xor_ln64_fu_334_p2;
reg   [3:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln56_fu_310_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln56_reg_456 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1_11001) & (icmp_ln56_reg_456_pp0_iter1_reg == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln56_reg_456 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage1_11001) & (icmp_ln56_reg_456 == 1'd0))) begin
        localLeft_reg_465 <= localLeft_fu_322_p2;
    end
end

always @ (*) begin
    if ((icmp_ln56_fu_310_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln56_reg_456 == 1'd0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (icmp_ln56_reg_456_pp0_iter1_reg == 1'd0))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (icmp_ln56_fu_310_p2 == 1'd1)) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage1;
            end else if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (icmp_ln56_fu_310_p2 == 1'd1))) begin
...
always @ (*) begin
    ap_condition_317 = ((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln56_fu_310_p2 == 1'd0));
end
...
assign ap_return_0 = xor_ln65_fu_339_p2;

assign ap_return_1 = xor_ln64_fu_334_p2;

assign grp_feistel_fu_297_ap_start = grp_feistel_fu_297_ap_start_reg;

assign grp_feistel_fu_297_x = (ap_phi_reg_pp0_iter0_phi_ln57_reg_260 ^ ap_phi_mux_p_tmp_phi_fu_231_p4);

assign i_fu_316_p2 = (ap_phi_mux_i_0_phi_fu_252_p4 + 5'd1);

assign icmp_ln56_fu_310_p2 = ((ap_phi_mux_i_0_phi_fu_252_p4 == 5'd16) ? 1'b1 : 1'b0);

assign localLeft_fu_322_p2 = (ap_phi_reg_pp0_iter0_phi_ln57_reg_260 ^ ap_phi_mux_p_tmp_phi_fu_231_p4);

assign localRight_fu_329_p2 = (p_b_read_assign_reg_238 ^ feistel_result_reg_471);

assign xor_ln64_fu_334_p2 = (p_tmp_reg_228 ^ P_16_read);

assign xor_ln65_fu_339_p2 = (p_b_read_assign_reg_238 ^ P_17_read);
