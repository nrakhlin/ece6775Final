...
wire   [0:0] icmp_ln319_fu_249_p2;
wire    ap_CS_fsm_state12;
wire   [4:0] i_11_fu_277_p2;
reg   [4:0] i_11_reg_402;
...
wire   [63:0] zext_ln321_fu_261_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_state14) & (icmp_ln225_fu_271_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state11) & (icmp_ln319_fu_249_p2 == 1'd1))) begin
        i_0_i4_reg_219 <= 5'd0;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state11) & (icmp_ln319_fu_249_p2 == 1'd0))) begin
        state_addr_41_reg_388 <= zext_ln321_fu_261_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state14) & (icmp_ln225_fu_271_p2 == 1'd0))) begin
        state_addr_42_reg_407 <= zext_ln226_fu_283_p1;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state14) & (icmp_ln225_fu_271_p2 == 1'd0))) begin
        ...
        state_address0 = zext_ln321_fu_261_p1;
    end else if ((1'b1 == ap_CS_fsm_state10)) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state4) | (1'b1 == ap_CS_fsm_state3) | (1'b1 == ap_CS_fsm_state7) | (1'b1 == ap_CS_fsm_state2) | (1'b1 == ap_CS_fsm_state9) | (1'b1 == ap_CS_fsm_state8) | (1'b1 == ap_CS_fsm_state10) | (1'b1 == ap_CS_fsm_state11) | (1'b1 == ap_CS_fsm_state6) | (1'b1 == ap_CS_fsm_state5) | ((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1)) | ((1'b1 == ap_CS_fsm_state14) & (icmp_ln225_fu_271_p2 == 1'd0)))) begin
        state_ce0 = 1'b1;
    end else if ((1'b1 == ap_CS_fsm_state16)) begin
        state_ce0 = grp_invMixColumns_fu_230_state_ce0;
    end else begin
...
assign i_11_fu_277_p2 = (i_0_i4_reg_219 + 5'd1);

assign i_fu_255_p2 = (i_0_i_reg_208 + 5'd1);

assign icmp_ln225_fu_271_p2 = ((i_0_i4_reg_219 == 5'd16) ? 1'b1 : 1'b0);

assign icmp_ln319_fu_249_p2 = ((i_0_i_reg_208 == 5'd16) ? 1'b1 : 1'b0);
...
assign zext_ln321_fu_261_p1 = i_0_i_reg_208;
