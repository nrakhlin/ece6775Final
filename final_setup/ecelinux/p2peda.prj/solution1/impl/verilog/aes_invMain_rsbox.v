...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module aes_invMain_rsbox_rom (
...
initial begin
    $readmemh("./aes_invMain_rsbox_rom.dat", ram0);
    $readmemh("./aes_invMain_rsbox_rom.dat", ram1);
end
...
aes_invMain_rsbox_rom aes_invMain_rsbox_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
