...
#define AUTOTB_TVOUT_PC_ap_return  "../tv/rtldatafile/rtl.lfsr.autotvout_ap_return.dat"
...
extern ap_uint<24> lfsr (
ap_uint<24> seed);

ap_uint<24> AESL_WRAP_lfsr (
ap_uint<24> seed)
{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			if (i > 0)
			{
				// RTL Name: ap_return
				{
					// bitslice(23, 0)
					// {
						// celement: agg.result.V(23, 0)
						// {
							sc_lv<24> agg_result_V_lv0_0_0_0;
						// }
					// }
					...
					// bitslice(23, 0)
					{
						// celement: agg.result.V(23, 0)
						{
							// carray: (0) => (0) @ (0)
							{
								...
								{
									agg_result_V_lv0_0_0_0.range(23, 0) = sc_bv<24>(ap_return_pc_buffer.range(23, 0));
								}
							}
						}
					}
	...
	else
	{
		...
		sc_bv<24> seed_V_tvin_wrapc_buffer;

		// RTL Name: seed_V
		{
			// bitslice(23, 0)
			{
				// celement: seed.V(23, 0)
				{
					// carray: (0) => (0) @ (0)
					{
						// sub                   : 
						...
						{
							sc_lv<24> seed_V_tmp_mem;
							seed_V_tmp_mem = (seed).to_string(2).c_str();
							seed_V_tvin_wrapc_buffer.range(23, 0) = seed_V_tmp_mem.range(23, 0);
						}
					}
				}
			}
...
// [call_c_dut] ---------->
		...
		ap_uint<24> AESL_return = lfsr(seed);
		...
		sc_bv<24> ap_return_tvout_wrapc_buffer;
			...
			// bitslice(23, 0)
			{
				// celement: agg.result.V(23, 0)
				{
					// carray: (0) => (0) @ (0)
					{
						...
						if (&(AESL_return) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<24> agg_result_V_tmp_mem;
							agg_result_V_tmp_mem = (AESL_return).to_string(2).c_str();
							ap_return_tvout_wrapc_buffer.range(23, 0) = agg_result_V_tmp_mem.range(23, 0);
						}
					}
				}
			}
