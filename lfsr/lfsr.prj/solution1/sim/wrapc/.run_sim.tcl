...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "lfsr.autotvin.dat"
	set constFileTvOut       "lfsr.autotvout.dat"
	set constFileHdlTvIn     "lfsr.autohdltvin.dat"
	set constFileHdlTvOut    "lfsr.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
