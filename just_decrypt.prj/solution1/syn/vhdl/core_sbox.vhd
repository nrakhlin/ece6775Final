...
architecture rtl of core_sbox_rom is 
...
architecture arch of core_sbox is
    component core_sbox_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    core_sbox_rom_U :  component core_sbox_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
