...
architecture behav of core is 
    ...
    signal icmp_ln85_fu_221_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((icmp_ln85_fu_221_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    phi_ln86_reg_197_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln85_fu_221_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, icmp_ln85_fu_221_p2, ap_CS_fsm_state4, icmp_ln103_fu_334_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((icmp_ln85_fu_221_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
    ...
    icmp_ln85_fu_221_p2 <= "1" when (i_0_i_reg_185 = ap_const_lv2_3) else "0";
    num_assign_1_fu_362_p5 <= i_0_reg_210(2 - 1 downto 0);
    sbox_address0 <= zext_ln64_fu_376_p1(8 - 1 downto 0);
    ...
    zext_ln64_fu_376_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(num_assign_1_fu_362_p6),64));
