...
architecture behav of core is 
    ...
    signal icmp_ln92_fu_221_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal trunc_ln112_fu_358_p1 : STD_LOGIC_VECTOR (1 downto 0);
    signal trunc_ln112_reg_590 : STD_LOGIC_VECTOR (1 downto 0);
    signal icmp_ln110_fu_334_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal trunc_ln116_fu_381_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal xor_ln116_fu_441_p2 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    component encrypt_dut_mux_4bkb IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    ...
    encrypt_dut_mux_4bkb_U1 : component encrypt_dut_mux_4bkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    encrypt_dut_mux_4cud_U2 : component encrypt_dut_mux_4cud
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 8,
    ...
    port map (
        ...
        din1 => phi_ln93_reg_197,
        din2 => word12_0_i_reg_175,
        din3 => word12_0_i_reg_175,
        din4 => i_0_i_reg_185,
        dout => word12_0_be_i_fu_292_p6);

    encrypt_dut_mux_4cud_U3 : component encrypt_dut_mux_4cud
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 8,
    ...
    port map (
        ...
        din2 => phi_ln93_reg_197,
        din3 => phi_ln93_reg_197,
        din4 => i_0_i_reg_185,
        dout => word2_0_be_i_fu_306_p6);

    encrypt_dut_mux_4cud_U4 : component encrypt_dut_mux_4cud
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 8,
    ...
    encrypt_dut_mux_4cud_U5 : component encrypt_dut_mux_4cud
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 8,
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
                    ap_return_3_preg <= xor_ln116_fu_441_p2;
                end if; 
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((trunc_ln112_reg_590 = ap_const_lv2_0) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
                empty_14_fu_58 <= sbox_q0;
            elsif (((icmp_ln92_fu_221_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
                empty_14_fu_58 <= select_ln95_fu_247_p3;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((trunc_ln112_reg_590 = ap_const_lv2_1) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((trunc_ln112_reg_590 = ap_const_lv2_2) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((trunc_ln112_reg_590 = ap_const_lv2_3) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((trunc_ln112_reg_590 = ap_const_lv2_0) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
                ...
                word_load_fu_54 <= select_ln95_fu_247_p3;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln110_fu_334_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
                trunc_ln112_reg_590 <= trunc_ln112_fu_358_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, icmp_ln92_fu_221_p2, ap_CS_fsm_state4, icmp_ln110_fu_334_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((icmp_ln92_fu_221_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
            ...
            when ap_ST_fsm_state4 => 
                if (((icmp_ln110_fu_334_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
    ...
    Rcon_address0 <= zext_ln99_fu_384_p1(8 - 1 downto 0);
    ...
    ap_return_3_assign_proc : process(ap_CS_fsm_state6, xor_ln116_fu_441_p2, ap_return_3_preg)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
            ap_return_3 <= xor_ln116_fu_441_p2;
        else 
    ...
    icmp_ln110_fu_334_p2 <= "1" when (i_0_reg_210 = ap_const_lv3_4) else "0";
    icmp_ln92_fu_221_p2 <= "1" when (i_0_i_reg_185 = ap_const_lv2_3) else "0";
    num_assign_1_fu_362_p5 <= i_0_reg_210(2 - 1 downto 0);
    sbox_address0 <= zext_ln71_fu_376_p1(8 - 1 downto 0);
    ...
    select_ln95_fu_247_p3 <= 
        word_03_i_reg_153 when (write_flag_0_i_reg_142(0) = '1') else 
        word_0_read;
    trunc_ln112_fu_358_p1 <= i_0_reg_210(2 - 1 downto 0);
    trunc_ln116_fu_381_p1 <= iteration(8 - 1 downto 0);
    xor_ln116_fu_441_p2 <= (word_load_fu_54 xor Rcon_q0);
    zext_ln71_fu_376_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(num_assign_1_fu_362_p6),64));
    zext_ln99_fu_384_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(trunc_ln116_fu_381_p1),64));
end behav;
