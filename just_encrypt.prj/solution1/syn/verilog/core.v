...
wire   [1:0] trunc_ln112_fu_358_p1;
reg   [1:0] trunc_ln112_reg_590;
...
reg   [7:0] phi_ln93_reg_197;
reg   [2:0] i_0_reg_210;
wire    ap_CS_fsm_state5;
wire   [63:0] zext_ln71_fu_376_p1;
wire   [63:0] zext_ln99_fu_384_p1;
reg   [7:0] word_load_fu_54;
wire   [7:0] select_ln95_fu_247_p3;
...
wire   [7:0] trunc_ln116_fu_381_p1;
wire   [7:0] xor_ln116_fu_441_p2;
...
always @ (posedge ap_clk) begin
    if (((trunc_ln112_reg_590 == 2'd0) & (1'b1 == ap_CS_fsm_state5))) begin
        empty_14_fu_58 <= sbox_q0;
    end else if (((icmp_ln92_fu_221_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        empty_14_fu_58 <= select_ln95_fu_247_p3;
    end
end

always @ (posedge ap_clk) begin
    if (((trunc_ln112_reg_590 == 2'd1) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (posedge ap_clk) begin
    if (((trunc_ln112_reg_590 == 2'd2) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (posedge ap_clk) begin
    if (((trunc_ln112_reg_590 == 2'd3) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln92_fu_221_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln110_fu_334_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((icmp_ln92_fu_221_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ...
        ap_ST_fsm_state4 : begin
            if (((icmp_ln110_fu_334_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
...
assign Rcon_address0 = zext_ln99_fu_384_p1;
...
assign icmp_ln110_fu_334_p2 = ((i_0_reg_210 == 3'd4) ? 1'b1 : 1'b0);

assign icmp_ln92_fu_221_p2 = ((i_0_i_reg_185 == 2'd3) ? 1'b1 : 1'b0);

assign num_assign_1_fu_362_p5 = i_0_reg_210[1:0];

assign sbox_address0 = zext_ln71_fu_376_p1;

assign select_ln95_fu_247_p3 = ((write_flag_0_i_reg_142[0:0] === 1'b1) ? word_03_i_reg_153 : word_0_read);

assign trunc_ln112_fu_358_p1 = i_0_reg_210[1:0];

assign trunc_ln116_fu_381_p1 = iteration[7:0];

assign xor_ln116_fu_441_p2 = (word_load_fu_54 ^ Rcon_q0);

assign zext_ln71_fu_376_p1 = num_assign_1_fu_362_p6;

assign zext_ln99_fu_384_p1 = trunc_ln116_fu_381_p1;
