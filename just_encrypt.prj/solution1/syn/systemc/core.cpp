...
core::core(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    Rcon_U->ce0(Rcon_ce0);
    Rcon_U->q0(Rcon_q0);
    encrypt_dut_mux_4bkb_U1 = new encrypt_dut_mux_4bkb<1,1,1,1,1,1,2,1>("encrypt_dut_mux_4bkb_U1");
    encrypt_dut_mux_4bkb_U1->din0(ap_var_for_const0);
    encrypt_dut_mux_4bkb_U1->din1(write_flag_0_i_reg_142);
    encrypt_dut_mux_4bkb_U1->din2(write_flag_0_i_reg_142);
    encrypt_dut_mux_4bkb_U1->din3(write_flag_0_i_reg_142);
    encrypt_dut_mux_4bkb_U1->din4(i_0_i_reg_185);
    encrypt_dut_mux_4bkb_U1->dout(write_flag_0_be_i_fu_233_p6);
    encrypt_dut_mux_4cud_U2 = new encrypt_dut_mux_4cud<1,1,8,8,8,8,2,8>("encrypt_dut_mux_4cud_U2");
    encrypt_dut_mux_4cud_U2->din0(word12_0_i_reg_175);
    encrypt_dut_mux_4cud_U2->din1(phi_ln93_reg_197);
    encrypt_dut_mux_4cud_U2->din2(word12_0_i_reg_175);
    encrypt_dut_mux_4cud_U2->din3(word12_0_i_reg_175);
    encrypt_dut_mux_4cud_U2->din4(i_0_i_reg_185);
    encrypt_dut_mux_4cud_U2->dout(word12_0_be_i_fu_292_p6);
    encrypt_dut_mux_4cud_U3 = new encrypt_dut_mux_4cud<1,1,8,8,8,8,2,8>("encrypt_dut_mux_4cud_U3");
    encrypt_dut_mux_4cud_U3->din0(word2_0_i_reg_165);
    encrypt_dut_mux_4cud_U3->din1(word2_0_i_reg_165);
    encrypt_dut_mux_4cud_U3->din2(phi_ln93_reg_197);
    encrypt_dut_mux_4cud_U3->din3(phi_ln93_reg_197);
    encrypt_dut_mux_4cud_U3->din4(i_0_i_reg_185);
    encrypt_dut_mux_4cud_U3->dout(word2_0_be_i_fu_306_p6);
    encrypt_dut_mux_4cud_U4 = new encrypt_dut_mux_4cud<1,1,8,8,8,8,2,8>("encrypt_dut_mux_4cud_U4");
    encrypt_dut_mux_4cud_U4->din0(phi_ln93_reg_197);
    encrypt_dut_mux_4cud_U4->din1(word_03_i_reg_153);
    encrypt_dut_mux_4cud_U4->din2(word_03_i_reg_153);
    encrypt_dut_mux_4cud_U4->din3(word_03_i_reg_153);
    encrypt_dut_mux_4cud_U4->din4(i_0_i_reg_185);
    encrypt_dut_mux_4cud_U4->dout(word_03_be_i_fu_320_p6);
    encrypt_dut_mux_4cud_U5 = new encrypt_dut_mux_4cud<1,1,8,8,8,8,2,8>("encrypt_dut_mux_4cud_U5");
    encrypt_dut_mux_4cud_U5->din0(empty_14_fu_58);
    encrypt_dut_mux_4cud_U5->din1(empty_15_fu_62);
    encrypt_dut_mux_4cud_U5->din2(empty_16_fu_66);
    encrypt_dut_mux_4cud_U5->din3(empty_17_fu_70);
    encrypt_dut_mux_4cud_U5->din4(num_assign_1_fu_362_p5);
    encrypt_dut_mux_4cud_U5->dout(num_assign_1_fu_362_p6);
    ...
    SC_METHOD(thread_icmp_ln110_fu_334_p2);
    sensitive << ( ap_CS_fsm_state4 );
    sensitive << ( i_0_reg_210 );

    SC_METHOD(thread_icmp_ln92_fu_221_p2);
    ...
    sensitive << ( ap_CS_fsm_state4 );
    sensitive << ( zext_ln71_fu_376_p1 );

    SC_METHOD(thread_sbox_ce0);
    sensitive << ( ap_CS_fsm_state4 );

    SC_METHOD(thread_select_ln95_fu_247_p3);
    sensitive << ( word_0_read );
    sensitive << ( write_flag_0_i_reg_142 );
    sensitive << ( word_03_i_reg_153 );

    SC_METHOD(thread_trunc_ln112_fu_358_p1);
    sensitive << ( i_0_reg_210 );

    SC_METHOD(thread_trunc_ln116_fu_381_p1);
    sensitive << ( iteration );

    SC_METHOD(thread_xor_ln116_fu_441_p2);
    sensitive << ( Rcon_q0 );
    sensitive << ( word_load_fu_54 );

    SC_METHOD(thread_zext_ln71_fu_376_p1);
    sensitive << ( num_assign_1_fu_362_p6 );

    SC_METHOD(thread_zext_ln99_fu_384_p1);
    sensitive << ( trunc_ln116_fu_381_p1 );
    ...
    sensitive << ( ap_CS_fsm_state1 );
    sensitive << ( ap_CS_fsm_state2 );
    sensitive << ( icmp_ln92_fu_221_p2 );
    sensitive << ( ap_CS_fsm_state4 );
    sensitive << ( icmp_ln110_fu_334_p2 );
    ...
    sc_trace(mVcdFile, icmp_ln92_fu_221_p2, "icmp_ln92_fu_221_p2");
    ...
    sc_trace(mVcdFile, trunc_ln112_fu_358_p1, "trunc_ln112_fu_358_p1");
    sc_trace(mVcdFile, trunc_ln112_reg_590, "trunc_ln112_reg_590");
    sc_trace(mVcdFile, icmp_ln110_fu_334_p2, "icmp_ln110_fu_334_p2");
    ...
    sc_trace(mVcdFile, phi_ln93_reg_197, "phi_ln93_reg_197");
    sc_trace(mVcdFile, i_0_reg_210, "i_0_reg_210");
    sc_trace(mVcdFile, ap_CS_fsm_state5, "ap_CS_fsm_state5");
    sc_trace(mVcdFile, zext_ln71_fu_376_p1, "zext_ln71_fu_376_p1");
    sc_trace(mVcdFile, zext_ln99_fu_384_p1, "zext_ln99_fu_384_p1");
    sc_trace(mVcdFile, word_load_fu_54, "word_load_fu_54");
    sc_trace(mVcdFile, select_ln95_fu_247_p3, "select_ln95_fu_247_p3");
    ...
    sc_trace(mVcdFile, trunc_ln116_fu_381_p1, "trunc_ln116_fu_381_p1");
    sc_trace(mVcdFile, xor_ln116_fu_441_p2, "xor_ln116_fu_441_p2");
...
core::~core() {
    ...
    delete sbox_U;
    delete Rcon_U;
    delete encrypt_dut_mux_4bkb_U1;
    delete encrypt_dut_mux_4cud_U2;
    delete encrypt_dut_mux_4cud_U3;
    delete encrypt_dut_mux_4cud_U4;
    delete encrypt_dut_mux_4cud_U5;
}
...
void core::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state6.read())) {
            ap_return_3_preg = xor_ln116_fu_441_p2.read();
        }
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read()) && 
         esl_seteq<1,2,2>(trunc_ln112_reg_590.read(), ap_const_lv2_0))) {
        empty_14_fu_58 = sbox_q0.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
                esl_seteq<1,1,1>(icmp_ln92_fu_221_p2.read(), ap_const_lv1_1))) {
        empty_14_fu_58 = select_ln95_fu_247_p3.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read()) && 
         esl_seteq<1,2,2>(trunc_ln112_reg_590.read(), ap_const_lv2_1))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read()) && 
         esl_seteq<1,2,2>(trunc_ln112_reg_590.read(), ap_const_lv2_2))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read()) && 
         esl_seteq<1,2,2>(trunc_ln112_reg_590.read(), ap_const_lv2_3))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(icmp_ln92_fu_221_p2.read(), ap_const_lv1_0))) {
        if (esl_seteq<1,2,2>(ap_const_lv2_0, ap_phi_mux_i_0_i_phi_fu_189_p4.read())) {
            phi_ln93_reg_197 = word12_0_i_reg_175.read();
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read()) && 
        ...
        word_load_fu_54 = sbox_q0.read();
                ...
                esl_seteq<1,1,1>(icmp_ln92_fu_221_p2.read(), ap_const_lv1_1))) {
        word_load_fu_54 = select_ln95_fu_247_p3.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln110_fu_334_p2.read()))) {
        trunc_ln112_reg_590 = trunc_ln112_fu_358_p1.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
...
void core::thread_Rcon_address0() {
    Rcon_address0 =  (sc_lv<8>) (zext_ln99_fu_384_p1.read());
}
...
void core::thread_ap_return_3() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state6.read())) {
        ap_return_3 = xor_ln116_fu_441_p2.read();
    } else {
...
void core::thread_icmp_ln110_fu_334_p2() {
    icmp_ln110_fu_334_p2 = (!i_0_reg_210.read().is_01() || !ap_const_lv3_4.is_01())? sc_lv<1>(): sc_lv<1>(i_0_reg_210.read() == ap_const_lv3_4);
}

void core::thread_icmp_ln92_fu_221_p2() {
    icmp_ln92_fu_221_p2 = (!i_0_i_reg_185.read().is_01() || !ap_const_lv2_3.is_01())? sc_lv<1>(): sc_lv<1>(i_0_i_reg_185.read() == ap_const_lv2_3);
}
...
void core::thread_sbox_address0() {
    sbox_address0 =  (sc_lv<8>) (zext_ln71_fu_376_p1.read());
}
...
void core::thread_select_ln95_fu_247_p3() {
    select_ln95_fu_247_p3 = (!write_flag_0_i_reg_142.read()[0].is_01())? sc_lv<8>(): ((write_flag_0_i_reg_142.read()[0].to_bool())? word_03_i_reg_153.read(): word_0_read.read());
}

void core::thread_trunc_ln112_fu_358_p1() {
    trunc_ln112_fu_358_p1 = i_0_reg_210.read().range(2-1, 0);
}

void core::thread_trunc_ln116_fu_381_p1() {
    trunc_ln116_fu_381_p1 = iteration.read().range(8-1, 0);
}

void core::thread_xor_ln116_fu_441_p2() {
    xor_ln116_fu_441_p2 = (Rcon_q0.read() ^ word_load_fu_54.read());
}

void core::thread_zext_ln71_fu_376_p1() {
    zext_ln71_fu_376_p1 = esl_zext<64,8>(num_assign_1_fu_362_p6.read());
}

void core::thread_zext_ln99_fu_384_p1() {
    zext_ln99_fu_384_p1 = esl_zext<64,8>(trunc_ln116_fu_381_p1.read());
}
...
void core::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            ...
            break;
        case 2 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(icmp_ln92_fu_221_p2.read(), ap_const_lv1_1))) {
        ...
        case 4 : 
            ...
            break;
        case 8 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read()) && esl_seteq<1,1,1>(icmp_ln110_fu_334_p2.read(), ap_const_lv1_1))) {
