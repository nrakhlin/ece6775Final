...
#include "encrypt_dut_mux_4bkb.h"
...
struct core : public sc_module {
    ...
    core_sbox* sbox_U;
    core_Rcon* Rcon_U;
    encrypt_dut_mux_4bkb<1,1,1,1,1,1,2,1>* encrypt_dut_mux_4bkb_U1;
    encrypt_dut_mux_4cud<1,1,8,8,8,8,2,8>* encrypt_dut_mux_4cud_U2;
    encrypt_dut_mux_4cud<1,1,8,8,8,8,2,8>* encrypt_dut_mux_4cud_U3;
    encrypt_dut_mux_4cud<1,1,8,8,8,8,2,8>* encrypt_dut_mux_4cud_U4;
    encrypt_dut_mux_4cud<1,1,8,8,8,8,2,8>* encrypt_dut_mux_4cud_U5;
    ...
    sc_signal< sc_lv<1> > icmp_ln92_fu_221_p2;
    ...
    sc_signal< sc_lv<2> > trunc_ln112_fu_358_p1;
    sc_signal< sc_lv<2> > trunc_ln112_reg_590;
    sc_signal< sc_lv<1> > icmp_ln110_fu_334_p2;
    ...
    sc_signal< sc_lv<8> > phi_ln93_reg_197;
    sc_signal< sc_lv<3> > i_0_reg_210;
    sc_signal< sc_logic > ap_CS_fsm_state5;
    sc_signal< sc_lv<64> > zext_ln71_fu_376_p1;
    sc_signal< sc_lv<64> > zext_ln99_fu_384_p1;
    sc_signal< sc_lv<8> > word_load_fu_54;
    sc_signal< sc_lv<8> > select_ln95_fu_247_p3;
    ...
    sc_signal< sc_lv<8> > trunc_ln116_fu_381_p1;
    sc_signal< sc_lv<8> > xor_ln116_fu_441_p2;
    ...
    void thread_icmp_ln110_fu_334_p2();
    void thread_icmp_ln92_fu_221_p2();
    void thread_num_assign_1_fu_362_p5();
    void thread_sbox_address0();
    void thread_sbox_ce0();
    void thread_select_ln95_fu_247_p3();
    void thread_trunc_ln112_fu_358_p1();
    void thread_trunc_ln116_fu_381_p1();
    void thread_xor_ln116_fu_441_p2();
    void thread_zext_ln71_fu_376_p1();
    void thread_zext_ln99_fu_384_p1();
