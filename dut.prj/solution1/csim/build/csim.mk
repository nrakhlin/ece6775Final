...
HLS_SOURCES = ../../../../aes_test.cpp ../../../../aes_new.cpp
...
$(ObjDir)/aes_test.o: ../../../../aes_test.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../aes_test.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -std=c++11 -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) -DNDEBUG $< -o $@ ; \

-include $(ObjDir)/aes_test.d

$(ObjDir)/aes_new.o: ../../../../aes_new.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../aes_new.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -std=c++11  $(IFLAG) $(DFLAG) -DNDEBUG $< -o $@ ; \

-include $(ObjDir)/aes_new.d
