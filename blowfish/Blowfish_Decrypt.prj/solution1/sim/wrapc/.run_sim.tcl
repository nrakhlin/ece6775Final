...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "Blowfish_Decrypt.autotvin.dat"
	set constFileTvOut       "Blowfish_Decrypt.autotvout.dat"
	set constFileHdlTvIn     "Blowfish_Decrypt.autohdltvin.dat"
	set constFileHdlTvOut    "Blowfish_Decrypt.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
