...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.Blowfish_Decrypt.autotvin_ciphertext.dat"
         "c.Blowfish_Decrypt.autotvin_decryptedtext.dat"
         "c.Blowfish_Decrypt.autotvin_P.dat"
         "c.Blowfish_Decrypt.autotvin_S.dat"
         "c.Blowfish_Decrypt.autotvout_decryptedtext.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.Blowfish_Decrypt.autotvout_decryptedtext.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
