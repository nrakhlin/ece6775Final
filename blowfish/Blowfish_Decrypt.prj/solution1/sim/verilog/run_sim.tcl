...
if {[file isfile Blowfish_Decrypt.autotvin.dat]} {
	file delete -force Blowfish_Decrypt.autotvin.dat
}

if {[file isfile Blowfish_Decrypt.autotvout.dat]} {
	file delete -force Blowfish_Decrypt.autotvout.dat
}
