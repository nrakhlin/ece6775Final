...
`define AUTOTB_TVIN_ciphertext  "./c.Blowfish_Decrypt.autotvin_ciphertext.dat"
`define AUTOTB_TVIN_decryptedtext  "./c.Blowfish_Decrypt.autotvin_decryptedtext.dat"
`define AUTOTB_TVIN_P  "./c.Blowfish_Decrypt.autotvin_P.dat"
`define AUTOTB_TVIN_S  "./c.Blowfish_Decrypt.autotvin_S.dat"
`define AUTOTB_TVIN_ciphertext_out_wrapc  "./rtl.Blowfish_Decrypt.autotvin_ciphertext.dat"
`define AUTOTB_TVIN_decryptedtext_out_wrapc  "./rtl.Blowfish_Decrypt.autotvin_decryptedtext.dat"
`define AUTOTB_TVIN_P_out_wrapc  "./rtl.Blowfish_Decrypt.autotvin_P.dat"
`define AUTOTB_TVIN_S_out_wrapc  "./rtl.Blowfish_Decrypt.autotvin_S.dat"
`define AUTOTB_TVOUT_decryptedtext  "./c.Blowfish_Decrypt.autotvout_decryptedtext.dat"
`define AUTOTB_TVOUT_decryptedtext_out_wrapc  "./impl_rtl.Blowfish_Decrypt.autotvout_decryptedtext.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.Blowfish_Decrypt.autotvout_decryptedtext.dat", "r");
    fp2 = $fopen("./impl_rtl.Blowfish_Decrypt.autotvout_decryptedtext.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.Blowfish_Decrypt.autotvout_decryptedtext.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.Blowfish_Decrypt.autotvout_decryptedtext.dat\"!");
    else begin
        $display("Comparing rtl.Blowfish_Decrypt.autotvout_decryptedtext.dat with impl_rtl.Blowfish_Decrypt.autotvout_decryptedtext.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
