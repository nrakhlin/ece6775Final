...
if {[file isfile Blowfish_SetKey.autotvin.dat]} {
	file delete -force Blowfish_SetKey.autotvin.dat
}

if {[file isfile Blowfish_SetKey.autotvout.dat]} {
	file delete -force Blowfish_SetKey.autotvout.dat
}
