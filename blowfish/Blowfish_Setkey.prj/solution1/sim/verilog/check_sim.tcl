...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.Blowfish_SetKey.autotvin_key.dat"
         "c.Blowfish_SetKey.autotvin_key_size.dat"
         "c.Blowfish_SetKey.autotvin_P.dat"
         "c.Blowfish_SetKey.autotvin_S.dat"
         "c.Blowfish_SetKey.autotvout_P.dat"
         "c.Blowfish_SetKey.autotvout_S.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.Blowfish_SetKey.autotvout_P.dat"
         "rtl.Blowfish_SetKey.autotvout_S.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
