...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "Blowfish_SetKey.autotvin.dat"
	set constFileTvOut       "Blowfish_SetKey.autotvout.dat"
	set constFileHdlTvIn     "Blowfish_SetKey.autohdltvin.dat"
	set constFileHdlTvOut    "Blowfish_SetKey.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
