...
Encrypt_SetKey::Encrypt_SetKey(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( icmp_ln49_fu_177_p2 );
    sensitive << ( zext_ln50_fu_189_p1 );
    ...
    sensitive << ( zext_ln102_fu_266_p1 );
    ...
    SC_METHOD(thread_add_ln102_1_fu_307_p2);
    sensitive << ( S_q1 );
    sensitive << ( xor_ln102_fu_302_p2 );

    SC_METHOD(thread_add_ln102_fu_280_p2);
    sensitive << ( S_q0 );
    sensitive << ( S_q1 );
    ...
    sensitive << ( xor_ln97_1_fu_224_p2 );

    SC_METHOD(thread_d_fu_260_p2);
    sensitive << ( trunc_ln50_1_fu_198_p1 );
    sensitive << ( trunc_ln50_fu_194_p1 );
    ...
    SC_METHOD(thread_icmp_ln49_fu_177_p2);
    sensitive << ( ap_CS_fsm_state2 );
    sensitive << ( i_0_reg_160 );
    ...
    SC_METHOD(thread_trunc_ln50_1_fu_198_p1);
    sensitive << ( p_tmp_reg_140 );

    SC_METHOD(thread_trunc_ln50_2_fu_202_p1);
    sensitive << ( p_tmp_reg_140 );

    SC_METHOD(thread_trunc_ln50_3_fu_206_p1);
    sensitive << ( P_q0 );

    SC_METHOD(thread_trunc_ln50_4_fu_210_p1);
    sensitive << ( p_tmp_reg_140 );

    SC_METHOD(thread_trunc_ln50_5_fu_214_p1);
    sensitive << ( P_q0 );

    SC_METHOD(thread_trunc_ln50_fu_194_p1);
    sensitive << ( P_q0 );

    SC_METHOD(thread_xor_ln102_fu_302_p2);
    sensitive << ( S_q0 );
    sensitive << ( add_ln102_reg_395 );

    SC_METHOD(thread_xor_ln51_fu_313_p2);
    sensitive << ( p_b_read_assign_2_reg_150 );
    sensitive << ( add_ln102_1_fu_307_p2 );

    SC_METHOD(thread_xor_ln56_fu_319_p2);
    sensitive << ( P_q1 );
    sensitive << ( p_b_read_assign_2_reg_150 );

    SC_METHOD(thread_xor_ln97_1_fu_224_p2);
    sensitive << ( trunc_ln50_3_fu_206_p1 );
    sensitive << ( trunc_ln50_2_fu_202_p1 );

    SC_METHOD(thread_xor_ln97_fu_218_p2);
    sensitive << ( trunc_ln50_5_fu_214_p1 );
    sensitive << ( trunc_ln50_4_fu_210_p1 );

    SC_METHOD(thread_zext_ln102_fu_266_p1);
    sensitive << ( a_fu_230_p4 );

    SC_METHOD(thread_zext_ln50_fu_189_p1);
    sensitive << ( i_0_reg_160 );
    ...
    sc_trace(mVcdFile, icmp_ln49_fu_177_p2, "icmp_ln49_fu_177_p2");
    ...
    sc_trace(mVcdFile, add_ln102_fu_280_p2, "add_ln102_fu_280_p2");
    sc_trace(mVcdFile, add_ln102_reg_395, "add_ln102_reg_395");
    sc_trace(mVcdFile, ap_CS_fsm_state4, "ap_CS_fsm_state4");
    sc_trace(mVcdFile, xor_ln51_fu_313_p2, "xor_ln51_fu_313_p2");
    ...
    sc_trace(mVcdFile, zext_ln50_fu_189_p1, "zext_ln50_fu_189_p1");
    sc_trace(mVcdFile, zext_ln102_fu_266_p1, "zext_ln102_fu_266_p1");
    ...
    sc_trace(mVcdFile, trunc_ln50_5_fu_214_p1, "trunc_ln50_5_fu_214_p1");
    sc_trace(mVcdFile, trunc_ln50_4_fu_210_p1, "trunc_ln50_4_fu_210_p1");
    sc_trace(mVcdFile, trunc_ln50_3_fu_206_p1, "trunc_ln50_3_fu_206_p1");
    sc_trace(mVcdFile, trunc_ln50_2_fu_202_p1, "trunc_ln50_2_fu_202_p1");
    sc_trace(mVcdFile, xor_ln97_1_fu_224_p2, "xor_ln97_1_fu_224_p2");
    sc_trace(mVcdFile, xor_ln97_fu_218_p2, "xor_ln97_fu_218_p2");
    sc_trace(mVcdFile, trunc_ln50_1_fu_198_p1, "trunc_ln50_1_fu_198_p1");
    sc_trace(mVcdFile, trunc_ln50_fu_194_p1, "trunc_ln50_fu_194_p1");
    sc_trace(mVcdFile, a_fu_230_p4, "a_fu_230_p4");
    sc_trace(mVcdFile, b_fu_240_p4, "b_fu_240_p4");
    sc_trace(mVcdFile, xor_ln102_fu_302_p2, "xor_ln102_fu_302_p2");
    sc_trace(mVcdFile, add_ln102_1_fu_307_p2, "add_ln102_1_fu_307_p2");
    sc_trace(mVcdFile, xor_ln56_fu_319_p2, "xor_ln56_fu_319_p2");
...
void Encrypt_SetKey::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state6.read())) {
            ap_return_0_preg = xor_ln56_fu_319_p2.read();
        }
    }
    if ( ap_rst.read() == ap_const_logic_1) {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read())) {
        p_tmp_reg_140 = xor_ln51_fu_313_p2.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
                esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1))) {
        p_tmp_reg_140 = left_read.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        add_ln102_reg_395 = add_ln102_fu_280_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        c_reg_375 = xor_ln97_fu_218_p2.read().range(15, 8);
...
void Encrypt_SetKey::thread_P_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        if (esl_seteq<1,1,1>(icmp_ln49_fu_177_p2.read(), ap_const_lv1_1)) {
            P_address0 =  (sc_lv<5>) (ap_const_lv64_10);
        } else if (esl_seteq<1,1,1>(icmp_ln49_fu_177_p2.read(), ap_const_lv1_0)) {
            P_address0 =  (sc_lv<5>) (zext_ln50_fu_189_p1.read());
        } else {
            P_address0 = "XXXXX";
        }
    } else {
...
void Encrypt_SetKey::thread_P_ce0() {
    if (((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
          esl_seteq<1,1,1>(icmp_ln49_fu_177_p2.read(), ap_const_lv1_0)) || 
         (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
          esl_seteq<1,1,1>(icmp_ln49_fu_177_p2.read(), ap_const_lv1_1)))) {
...
void Encrypt_SetKey::thread_S_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        S_address0 =  (sc_lv<10>) (tmp_1_fu_286_p3.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        S_address0 =  (sc_lv<10>) (zext_ln102_fu_266_p1.read());
    } else {
...
void Encrypt_SetKey::thread_S_address1() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        S_address1 =  (sc_lv<10>) (tmp_2_fu_294_p3.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
...
void Encrypt_SetKey::thread_add_ln102_1_fu_307_p2() {
    add_ln102_1_fu_307_p2 = (!S_q1.read().is_01() || !xor_ln102_fu_302_p2.read().is_01())? sc_lv<32>(): (sc_biguint<32>(S_q1.read()) + sc_biguint<32>(xor_ln102_fu_302_p2.read()));
}

void Encrypt_SetKey::thread_add_ln102_fu_280_p2() {
    add_ln102_fu_280_p2 = (!S_q0.read().is_01() || !S_q1.read().is_01())? sc_lv<32>(): (sc_biguint<32>(S_q0.read()) + sc_biguint<32>(S_q1.read()));
}
...
void Encrypt_SetKey::thread_ap_return_0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state6.read())) {
        ap_return_0 = xor_ln56_fu_319_p2.read();
    } else {
...
void Encrypt_SetKey::thread_b_fu_240_p4() {
    b_fu_240_p4 = xor_ln97_1_fu_224_p2.read().range(23, 16);
}

void Encrypt_SetKey::thread_d_fu_260_p2() {
    d_fu_260_p2 = (trunc_ln50_1_fu_198_p1.read() ^ trunc_ln50_fu_194_p1.read());
}
...
void Encrypt_SetKey::thread_icmp_ln49_fu_177_p2() {
    icmp_ln49_fu_177_p2 = (!i_0_reg_160.read().is_01() || !ap_const_lv5_10.is_01())? sc_lv<1>(): sc_lv<1>(i_0_reg_160.read() == ap_const_lv5_10);
}

void Encrypt_SetKey::thread_tmp_1_fu_286_p3() {
    tmp_1_fu_286_p3 = esl_concat<56,8>(ap_const_lv56_2, c_reg_375.read());
}

void Encrypt_SetKey::thread_tmp_2_fu_294_p3() {
    tmp_2_fu_294_p3 = esl_concat<56,8>(ap_const_lv56_3, d_reg_380.read());
}
...
void Encrypt_SetKey::thread_trunc_ln50_1_fu_198_p1() {
    trunc_ln50_1_fu_198_p1 = p_tmp_reg_140.read().range(8-1, 0);
}

void Encrypt_SetKey::thread_trunc_ln50_2_fu_202_p1() {
    trunc_ln50_2_fu_202_p1 = p_tmp_reg_140.read().range(24-1, 0);
}

void Encrypt_SetKey::thread_trunc_ln50_3_fu_206_p1() {
    trunc_ln50_3_fu_206_p1 = P_q0.read().range(24-1, 0);
}

void Encrypt_SetKey::thread_trunc_ln50_4_fu_210_p1() {
    trunc_ln50_4_fu_210_p1 = p_tmp_reg_140.read().range(16-1, 0);
}

void Encrypt_SetKey::thread_trunc_ln50_5_fu_214_p1() {
    trunc_ln50_5_fu_214_p1 = P_q0.read().range(16-1, 0);
}

void Encrypt_SetKey::thread_trunc_ln50_fu_194_p1() {
    trunc_ln50_fu_194_p1 = P_q0.read().range(8-1, 0);
}

void Encrypt_SetKey::thread_xor_ln102_fu_302_p2() {
    xor_ln102_fu_302_p2 = (S_q0.read() ^ add_ln102_reg_395.read());
}

void Encrypt_SetKey::thread_xor_ln51_fu_313_p2() {
    xor_ln51_fu_313_p2 = (p_b_read_assign_2_reg_150.read() ^ add_ln102_1_fu_307_p2.read());
}

void Encrypt_SetKey::thread_xor_ln56_fu_319_p2() {
    xor_ln56_fu_319_p2 = (P_q1.read() ^ p_b_read_assign_2_reg_150.read());
}

void Encrypt_SetKey::thread_xor_ln97_1_fu_224_p2() {
    xor_ln97_1_fu_224_p2 = (trunc_ln50_3_fu_206_p1.read() ^ trunc_ln50_2_fu_202_p1.read());
}

void Encrypt_SetKey::thread_xor_ln97_fu_218_p2() {
    xor_ln97_fu_218_p2 = (trunc_ln50_5_fu_214_p1.read() ^ trunc_ln50_4_fu_210_p1.read());
}

void Encrypt_SetKey::thread_zext_ln102_fu_266_p1() {
    zext_ln102_fu_266_p1 = esl_zext<64,8>(a_fu_230_p4.read());
}

void Encrypt_SetKey::thread_zext_ln50_fu_189_p1() {
    zext_ln50_fu_189_p1 = esl_zext<64,5>(i_0_reg_160.read());
}
...
void Encrypt_SetKey::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            ...
            break;
        case 2 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(icmp_ln49_fu_177_p2.read(), ap_const_lv1_1))) {
