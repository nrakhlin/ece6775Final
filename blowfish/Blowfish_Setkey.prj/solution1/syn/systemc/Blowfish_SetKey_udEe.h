...
// ==============================================================
#ifndef __Blowfish_SetKey_udEe__HH__
#define __Blowfish_SetKey_udEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Blowfish_SetKey_udEe) {
    ...
    SC_CTOR(Blowfish_SetKey_udEe):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
