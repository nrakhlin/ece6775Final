...
`define AUTOTB_TVIN_key  "./c.Blowfish_SetKey.autotvin_key.dat"
`define AUTOTB_TVIN_key_size  "./c.Blowfish_SetKey.autotvin_key_size.dat"
`define AUTOTB_TVIN_P  "./c.Blowfish_SetKey.autotvin_P.dat"
`define AUTOTB_TVIN_S  "./c.Blowfish_SetKey.autotvin_S.dat"
`define AUTOTB_TVIN_key_out_wrapc  "./rtl.Blowfish_SetKey.autotvin_key.dat"
`define AUTOTB_TVIN_key_size_out_wrapc  "./rtl.Blowfish_SetKey.autotvin_key_size.dat"
`define AUTOTB_TVIN_P_out_wrapc  "./rtl.Blowfish_SetKey.autotvin_P.dat"
`define AUTOTB_TVIN_S_out_wrapc  "./rtl.Blowfish_SetKey.autotvin_S.dat"
`define AUTOTB_TVOUT_P  "./c.Blowfish_SetKey.autotvout_P.dat"
`define AUTOTB_TVOUT_S  "./c.Blowfish_SetKey.autotvout_S.dat"
`define AUTOTB_TVOUT_P_out_wrapc  "./impl_rtl.Blowfish_SetKey.autotvout_P.dat"
`define AUTOTB_TVOUT_S_out_wrapc  "./impl_rtl.Blowfish_SetKey.autotvout_S.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.Blowfish_SetKey.autotvout_P.dat", "r");
    fp2 = $fopen("./impl_rtl.Blowfish_SetKey.autotvout_P.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.Blowfish_SetKey.autotvout_P.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.Blowfish_SetKey.autotvout_P.dat\"!");
    else begin
        $display("Comparing rtl.Blowfish_SetKey.autotvout_P.dat with impl_rtl.Blowfish_SetKey.autotvout_P.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.Blowfish_SetKey.autotvout_S.dat", "r");
    fp2 = $fopen("./impl_rtl.Blowfish_SetKey.autotvout_S.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.Blowfish_SetKey.autotvout_S.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.Blowfish_SetKey.autotvout_S.dat\"!");
    else begin
        $display("Comparing rtl.Blowfish_SetKey.autotvout_S.dat with impl_rtl.Blowfish_SetKey.autotvout_S.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
