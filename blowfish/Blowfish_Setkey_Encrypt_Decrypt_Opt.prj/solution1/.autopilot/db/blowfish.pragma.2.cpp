...
void Blowfish_Decrypt(unsigned char ciphertext[8], unsigned char decryptedtext[8], unsigned int P[18], unsigned int S[4][256]) {_ssdm_SpecArrayDimSize(ciphertext, 8);_ssdm_SpecArrayDimSize(decryptedtext, 8);_ssdm_SpecArrayDimSize(P, 18);_ssdm_SpecArrayDimSize(S, 4);
    unsigned int left, right;
...
_ssdm_SpecArrayReshape( &initial_sbox, 1,  "COMPLETE",  0, "");
