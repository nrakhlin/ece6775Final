...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "feistel.autotvin.dat"
	set constFileTvOut       "feistel.autotvout.dat"
	set constFileHdlTvIn     "feistel.autohdltvin.dat"
	set constFileHdlTvOut    "feistel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
