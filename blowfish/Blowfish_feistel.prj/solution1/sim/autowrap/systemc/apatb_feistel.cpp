...
#define AUTOTB_TVOUT_PC_ap_return  "../tv/rtldatafile/rtl.feistel.autotvout_ap_return.dat"
...
extern unsigned int feistel (
unsigned int x,
unsigned int S[4][256]);

unsigned int AESL_WRAP_feistel (
unsigned int x,
unsigned int S[4][256])
{
...
// [call_c_dut] ---------->
		...
		unsigned int AESL_return = feistel(x, S);
