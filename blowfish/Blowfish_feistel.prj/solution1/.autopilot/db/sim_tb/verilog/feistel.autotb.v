...
`define AUTOTB_DUT      feistel
`define AUTOTB_DUT_INST AESL_inst_feistel
`define AUTOTB_TOP      apatb_feistel_top
`define AUTOTB_LAT_RESULT_FILE "feistel.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "feistel.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_feistel_top
...
`define AUTOTB_TVIN_x  "./c.feistel.autotvin_x.dat"
`define AUTOTB_TVIN_S  "./c.feistel.autotvin_S.dat"
`define AUTOTB_TVIN_x_out_wrapc  "./rtl.feistel.autotvin_x.dat"
`define AUTOTB_TVIN_S_out_wrapc  "./rtl.feistel.autotvin_S.dat"
`define AUTOTB_TVOUT_ap_return  "./c.feistel.autotvout_ap_return.dat"
`define AUTOTB_TVOUT_ap_return_out_wrapc  "./impl_rtl.feistel.autotvout_ap_return.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 8368;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.feistel.autotvout_ap_return.dat", "r");
    fp2 = $fopen("./impl_rtl.feistel.autotvout_ap_return.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.feistel.autotvout_ap_return.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.feistel.autotvout_ap_return.dat\"!");
    else begin
        $display("Comparing rtl.feistel.autotvout_ap_return.dat with impl_rtl.feistel.autotvout_ap_return.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
