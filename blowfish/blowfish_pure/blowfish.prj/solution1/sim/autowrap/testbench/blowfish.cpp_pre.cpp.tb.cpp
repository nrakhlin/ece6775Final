...
void Blowfish::Encrypt_SetKey(bool set_key, const unsigned char key[56], int key_byte_length, unsigned char encrypted[8], const unsigned char plaintext[8]) {
    if(set_key){
...
void Blowfish::Encrypt_Decrypt_SetKey(bool set_key, const unsigned char key[56], int key_byte_length, unsigned char decrypted[8], unsigned char encrypted[8], const unsigned char plaintext[8]) {
    if(set_key){
        SetKey(key, key_byte_length);
    }
