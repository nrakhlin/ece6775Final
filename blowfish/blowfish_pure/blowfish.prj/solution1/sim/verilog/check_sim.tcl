...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.SetKey_Encrypt.autotvin_set_key.dat"
         "c.SetKey_Encrypt.autotvin_key.dat"
         "c.SetKey_Encrypt.autotvin_key_size.dat"
         "c.SetKey_Encrypt.autotvin_plaintext.dat"
         "c.SetKey_Encrypt.autotvin_ciphertext.dat"
         "c.SetKey_Encrypt.autotvin_P.dat"
         "c.SetKey_Encrypt.autotvin_S.dat"
         "c.SetKey_Encrypt.autotvout_ciphertext.dat"
         "c.SetKey_Encrypt.autotvout_P.dat"
         "c.SetKey_Encrypt.autotvout_S.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.SetKey_Encrypt.autotvout_ciphertext.dat"
         "rtl.SetKey_Encrypt.autotvout_P.dat"
         "rtl.SetKey_Encrypt.autotvout_S.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
