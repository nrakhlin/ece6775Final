...
if {[file isfile SetKey_Encrypt.autotvin.dat]} {
	file delete -force SetKey_Encrypt.autotvin.dat
}

if {[file isfile SetKey_Encrypt.autotvout.dat]} {
	file delete -force SetKey_Encrypt.autotvout.dat
}
