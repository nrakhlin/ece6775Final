...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "SetKey_Encrypt.autotvin.dat"
	set constFileTvOut       "SetKey_Encrypt.autotvout.dat"
	set constFileHdlTvIn     "SetKey_Encrypt.autohdltvin.dat"
	set constFileHdlTvOut    "SetKey_Encrypt.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
