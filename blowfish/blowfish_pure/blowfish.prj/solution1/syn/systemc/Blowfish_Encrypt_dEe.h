...
// ==============================================================
#ifndef __Blowfish_Encrypt_dEe__HH__
#define __Blowfish_Encrypt_dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Blowfish_Encrypt_dEe) {
    ...
    SC_CTOR(Blowfish_Encrypt_dEe):  ACMP_srem_seq_U ("ACMP_srem_seq_U") {
