...
// ==============================================================
#ifndef __SetKey_initial_pabkb_H__
#define __SetKey_initial_pabkb_H__
...
struct SetKey_initial_pabkb_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(SetKey_initial_pabkb_ram) {
...
SC_MODULE(SetKey_initial_pabkb) {
...
SetKey_initial_pabkb_ram* meminst;


SC_CTOR(SetKey_initial_pabkb) {
meminst = new SetKey_initial_pabkb_ram("SetKey_initial_pabkb_ram");
