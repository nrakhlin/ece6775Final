...
// ==============================================================
#ifndef __SetKey_Encrypt_urcud__HH__
#define __SetKey_Encrypt_urcud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(SetKey_Encrypt_urcud) {
    ...
    SC_CTOR(SetKey_Encrypt_urcud):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
