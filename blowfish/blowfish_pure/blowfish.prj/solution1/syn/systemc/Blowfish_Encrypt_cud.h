...
// ==============================================================
#ifndef __Blowfish_Encrypt_cud__HH__
#define __Blowfish_Encrypt_cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Blowfish_Encrypt_cud) {
    ...
    ACMP_srem_seq<ID, 11, din0_WIDTH, din1_WIDTH, dout_WIDTH> ACMP_srem_seq_U;

    SC_CTOR(Blowfish_Encrypt_cud):  ACMP_srem_seq_U ("ACMP_srem_seq_U") {
