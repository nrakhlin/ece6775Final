...
entity SetKey_initial_pabkb_rom is 
    generic(
             DWIDTH     : integer := 32; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 18
...
architecture rtl of SetKey_initial_pabkb_rom is 
...
entity SetKey_initial_pabkb is
    generic (
...
architecture arch of SetKey_initial_pabkb is
    component SetKey_initial_pabkb_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    SetKey_initial_pabkb_rom_U :  component SetKey_initial_pabkb_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
