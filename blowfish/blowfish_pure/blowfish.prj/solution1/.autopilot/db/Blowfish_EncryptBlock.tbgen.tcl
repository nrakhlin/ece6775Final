set moduleName Blowfish_EncryptBlock
set isTopModule 1
...
set C_modelName {Blowfish::EncryptBlock}
set C_modelType { void 0 }
set C_modelArgList {
	{ Blowfish_pary_s int 32 regular {array 18 { 1 1 } 1 1 }  }
	{ Blowfish_sbox_s int 32 regular {array 1024 { 1 1 } 1 1 }  }
	{ left_r int 32 regular {pointer 2}  }
	{ right_r int 32 regular {pointer 2}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "Blowfish_pary_s", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "Blowfish.pary_","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 17,"step" : 1}]}]}]} , 
 	{ "Name" : "Blowfish_sbox_s", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "Blowfish.sbox_","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 3,"step" : 1},{"low" : 0,"up" : 255,"step" : 1}]}]}]} , 
 	{ "Name" : "left_r", "interface" : "wire", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "left","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "Name" : "right_r", "interface" : "wire", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "right","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} ]}
...
set portList { 
	...
	{ left_r_i sc_in sc_lv 32 signal 2 } 
	{ left_r_o sc_out sc_lv 32 signal 2 } 
	{ left_r_o_ap_vld sc_out sc_logic 1 outvld 2 } 
	{ right_r_i sc_in sc_lv 32 signal 3 } 
	{ right_r_o sc_out sc_lv 32 signal 3 } 
	{ right_r_o_ap_vld sc_out sc_logic 1 outvld 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "left_r_i", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "left_r", "role": "i" }} , 
 	{ "name": "left_r_o", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "left_r", "role": "o" }} , 
 	{ "name": "left_r_o_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "left_r", "role": "o_ap_vld" }} , 
 	{ "name": "right_r_i", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "right_r", "role": "i" }} , 
 	{ "name": "right_r_o", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "right_r", "role": "o" }} , 
 	{ "name": "right_r_o_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "right_r", "role": "o_ap_vld" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		"CDFG" : "Blowfish_EncryptBlock",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "left_r", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "right_r", "Type" : "OVld", "Direction" : "IO"}]}]}
...
set ArgLastReadFirstWriteLatency {
	Blowfish_EncryptBlock {
		...
		left_r {Type IO LastRead 2 FirstWrite 2}
		right_r {Type IO LastRead 4 FirstWrite 2}}}
...
set Spec2ImplPortList { 
	...
	left_r { ap_ovld {  { left_r_i in_data 0 32 }  { left_r_o out_data 1 32 }  { left_r_o_ap_vld out_vld 1 1 } } }
	right_r { ap_ovld {  { right_r_i in_data 0 32 }  { right_r_o out_data 1 32 }  { right_r_o_ap_vld out_vld 1 1 } } }
}
