...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { Blowfish_pary_s_address0 { O 5 vector } Blowfish_pary_s_ce0 { O 1 bit } Blowfish_pary_s_q0 { I 32 vector } Blowfish_pary_s_address1 { O 5 vector } Blowfish_pary_s_ce1 { O 1 bit } Blowfish_pary_s_q1 { I 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_left_r \
    op interface \
    ports { left_r_i { I 32 vector } left_r_o { O 32 vector } left_r_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_right_r \
    op interface \
    ports { right_r_i { I 32 vector } right_r_o { O 32 vector } right_r_o_ap_vld { O 1 bit } } \
} "
}
