...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename plaintext \
    op interface \
    ports { plaintext_address0 { O 4 vector } plaintext_ce0 { O 1 bit } plaintext_q0 { I 8 vector } plaintext_address1 { O 4 vector } plaintext_ce1 { O 1 bit } plaintext_q1 { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename ciphertext \
    op interface \
    ports { ciphertext_address0 { O 4 vector } ciphertext_ce0 { O 1 bit } ciphertext_we0 { O 1 bit } ciphertext_d0 { O 8 vector } ciphertext_address1 { O 4 vector } ciphertext_ce1 { O 1 bit } ciphertext_we1 { O 1 bit } ciphertext_d1 { O 8 vector } } \
} "
} else {
