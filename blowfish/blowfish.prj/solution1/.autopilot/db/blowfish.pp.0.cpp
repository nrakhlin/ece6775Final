...
void Blowfish_Encrypt(const unsigned char plaintext[8 +1], unsigned char ciphertext[8 +1], unsigned int P[18], unsigned int S[4][256]) {_ssdm_SpecArrayDimSize(plaintext, 9);_ssdm_SpecArrayDimSize(ciphertext, 9);_ssdm_SpecArrayDimSize(P, 18);_ssdm_SpecArrayDimSize(S, 4);
...
void Blowfish_Decrypt(unsigned char ciphertext[8 +1], unsigned char decryptedtext[8 +1], unsigned int P[18], unsigned int S[4][256]) {_ssdm_SpecArrayDimSize(ciphertext, 9);_ssdm_SpecArrayDimSize(decryptedtext, 9);_ssdm_SpecArrayDimSize(P, 18);_ssdm_SpecArrayDimSize(S, 4);
    unsigned int left, right;
...
void Blowfish_SetKey_Encrypt(bool set_key, unsigned char key[56], size_t key_size, const unsigned char plaintext[8 +1], unsigned char ciphertext[8 +1], unsigned int P[18], unsigned int S[4][256]){_ssdm_SpecArrayDimSize(key, 56);_ssdm_SpecArrayDimSize(plaintext, 9);_ssdm_SpecArrayDimSize(ciphertext, 9);_ssdm_SpecArrayDimSize(P, 18);_ssdm_SpecArrayDimSize(S, 4);
    if(set_key){
...
void blockToWords(const unsigned char block[8 +1], unsigned int& left, unsigned int& right) {_ssdm_SpecArrayDimSize(block, 9);
    left = (block[0] << 24) | (block[1] << 16) | (block[2] << 8) | block[3];
    right = (block[4] << 24) | (block[5] << 16) | (block[6] << 8) | block[7];
}


void wordsToBlock(unsigned int left, unsigned int right, unsigned char block[8 +1]) {_ssdm_SpecArrayDimSize(block, 9);
