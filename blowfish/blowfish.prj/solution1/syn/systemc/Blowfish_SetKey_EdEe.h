...
// ==============================================================
#ifndef __Blowfish_SetKey_EdEe__HH__
#define __Blowfish_SetKey_EdEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Blowfish_SetKey_EdEe) {
    ...
    SC_CTOR(Blowfish_SetKey_EdEe):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
