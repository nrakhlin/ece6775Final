...
Encrypt_SetKey::Encrypt_SetKey(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_add_ln65_1_fu_307_p2);
    sensitive << ( S_q1 );
    sensitive << ( xor_ln65_fu_302_p2 );

    SC_METHOD(thread_add_ln65_fu_280_p2);
    sensitive << ( S_q0 );
    sensitive << ( S_q1 );
    ...
    sensitive << ( xor_ln60_1_fu_224_p2 );
    ...
    sensitive << ( add_ln65_1_fu_307_p2 );

    SC_METHOD(thread_xor_ln19_fu_319_p2);
    sensitive << ( P_q1 );
    sensitive << ( p_b_read_assign_2_reg_150 );

    SC_METHOD(thread_xor_ln60_1_fu_224_p2);
    sensitive << ( trunc_ln13_3_fu_206_p1 );
    sensitive << ( trunc_ln13_2_fu_202_p1 );

    SC_METHOD(thread_xor_ln60_fu_218_p2);
    sensitive << ( trunc_ln13_5_fu_214_p1 );
    sensitive << ( trunc_ln13_4_fu_210_p1 );

    SC_METHOD(thread_xor_ln65_fu_302_p2);
    sensitive << ( S_q0 );
    sensitive << ( add_ln65_reg_395 );

    SC_METHOD(thread_zext_ln13_fu_189_p1);
    sensitive << ( i_0_reg_160 );

    SC_METHOD(thread_zext_ln65_fu_266_p1);
    ...
    sc_trace(mVcdFile, add_ln65_fu_280_p2, "add_ln65_fu_280_p2");
    sc_trace(mVcdFile, add_ln65_reg_395, "add_ln65_reg_395");
    ...
    sc_trace(mVcdFile, zext_ln65_fu_266_p1, "zext_ln65_fu_266_p1");
    ...
    sc_trace(mVcdFile, xor_ln60_1_fu_224_p2, "xor_ln60_1_fu_224_p2");
    sc_trace(mVcdFile, xor_ln60_fu_218_p2, "xor_ln60_fu_218_p2");
    ...
    sc_trace(mVcdFile, xor_ln65_fu_302_p2, "xor_ln65_fu_302_p2");
    sc_trace(mVcdFile, add_ln65_1_fu_307_p2, "add_ln65_1_fu_307_p2");
...
void Encrypt_SetKey::thread_ap_clk_no_reset_() {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        add_ln65_reg_395 = add_ln65_fu_280_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        c_reg_375 = xor_ln60_fu_218_p2.read().range(15, 8);
...
void Encrypt_SetKey::thread_S_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        ...
        S_address0 =  (sc_lv<10>) (zext_ln65_fu_266_p1.read());
    } else {
...
void Encrypt_SetKey::thread_add_ln65_1_fu_307_p2() {
    add_ln65_1_fu_307_p2 = (!S_q1.read().is_01() || !xor_ln65_fu_302_p2.read().is_01())? sc_lv<32>(): (sc_biguint<32>(S_q1.read()) + sc_biguint<32>(xor_ln65_fu_302_p2.read()));
}

void Encrypt_SetKey::thread_add_ln65_fu_280_p2() {
    add_ln65_fu_280_p2 = (!S_q0.read().is_01() || !S_q1.read().is_01())? sc_lv<32>(): (sc_biguint<32>(S_q0.read()) + sc_biguint<32>(S_q1.read()));
}
...
void Encrypt_SetKey::thread_b_fu_240_p4() {
    b_fu_240_p4 = xor_ln60_1_fu_224_p2.read().range(23, 16);
}
...
void Encrypt_SetKey::thread_xor_ln14_fu_313_p2() {
    xor_ln14_fu_313_p2 = (p_b_read_assign_2_reg_150.read() ^ add_ln65_1_fu_307_p2.read());
}
...
void Encrypt_SetKey::thread_xor_ln60_1_fu_224_p2() {
    xor_ln60_1_fu_224_p2 = (trunc_ln13_3_fu_206_p1.read() ^ trunc_ln13_2_fu_202_p1.read());
}

void Encrypt_SetKey::thread_xor_ln60_fu_218_p2() {
    xor_ln60_fu_218_p2 = (trunc_ln13_5_fu_214_p1.read() ^ trunc_ln13_4_fu_210_p1.read());
}

void Encrypt_SetKey::thread_xor_ln65_fu_302_p2() {
    xor_ln65_fu_302_p2 = (S_q0.read() ^ add_ln65_reg_395.read());
}
...
void Encrypt_SetKey::thread_zext_ln65_fu_266_p1() {
    zext_ln65_fu_266_p1 = esl_zext<64,8>(a_fu_230_p4.read());
}
