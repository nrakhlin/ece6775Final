...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "Blowfish_SetKey_Encrypt.autotvin.dat"
	set constFileTvOut       "Blowfish_SetKey_Encrypt.autotvout.dat"
	set constFileHdlTvIn     "Blowfish_SetKey_Encrypt.autohdltvin.dat"
	set constFileHdlTvOut    "Blowfish_SetKey_Encrypt.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
