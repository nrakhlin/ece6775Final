...
if {[file isfile Blowfish_SetKey_Encrypt.autotvin.dat]} {
	file delete -force Blowfish_SetKey_Encrypt.autotvin.dat
}

if {[file isfile Blowfish_SetKey_Encrypt.autotvout.dat]} {
	file delete -force Blowfish_SetKey_Encrypt.autotvout.dat
}
