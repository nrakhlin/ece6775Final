...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.Blowfish_SetKey_Encrypt.autotvin_set_key.dat"
         "c.Blowfish_SetKey_Encrypt.autotvin_key.dat"
         "c.Blowfish_SetKey_Encrypt.autotvin_key_size.dat"
         "c.Blowfish_SetKey_Encrypt.autotvin_plaintext.dat"
         "c.Blowfish_SetKey_Encrypt.autotvin_ciphertext.dat"
         "c.Blowfish_SetKey_Encrypt.autotvin_P.dat"
         "c.Blowfish_SetKey_Encrypt.autotvin_S.dat"
         "c.Blowfish_SetKey_Encrypt.autotvout_ciphertext.dat"
         "c.Blowfish_SetKey_Encrypt.autotvout_P.dat"
         "c.Blowfish_SetKey_Encrypt.autotvout_S.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.Blowfish_SetKey_Encrypt.autotvout_ciphertext.dat"
         "rtl.Blowfish_SetKey_Encrypt.autotvout_P.dat"
         "rtl.Blowfish_SetKey_Encrypt.autotvout_S.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
