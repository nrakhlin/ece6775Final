...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.Blowfish_SetKey_Encrypt.autotvin_key.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.Blowfish_SetKey_Encrypt.autotvout_key.dat"; 
//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 8;
parameter ADDR_WIDTH = 32'd 6;
parameter DEPTH = 32'd 56;
parameter DLY = 0.1;
