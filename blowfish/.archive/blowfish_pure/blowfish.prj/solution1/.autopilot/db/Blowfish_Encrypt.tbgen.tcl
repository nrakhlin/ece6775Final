...
set C_modelName {Blowfish::Encrypt}
set C_modelType { void 0 }
set C_modelArgList {
	{ Blowfish_pary_s int 32 unused {array 18 { } 0 1 }  }
	{ Blowfish_sbox_s int 32 regular {array 1024 { 1 1 } 1 1 }  }
	{ dst int 8 regular {array 8 { 2 2 } 1 1 }  }
	{ src int 8 regular {array 8 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "Blowfish_pary_s", "interface" : "memory", "bitwidth" : 32, "direction" : "NONE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "Blowfish.pary_","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 17,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "dst", "interface" : "memory", "bitwidth" : 8, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "dst","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 7,"step" : 1}]}]}]} , 
 	{ "Name" : "src", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "src","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 7,"step" : 1}]}]}]} ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "Blowfish_pary_s", "Type" : "Memory", "Direction" : "X"},
			{"Name" : "Blowfish_sbox_s", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "dst", "Type" : "Memory", "Direction" : "IO"},
			{"Name" : "src", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.pary_s_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	Blowfish_Encrypt {
		Blowfish_pary_s {Type X LastRead -1 FirstWrite -1}
