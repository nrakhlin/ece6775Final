...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "Blowfish_Encrypt.autotvin.dat"
	set constFileTvOut       "Blowfish_Encrypt.autotvout.dat"
	set constFileHdlTvIn     "Blowfish_Encrypt.autohdltvin.dat"
	set constFileHdlTvOut    "Blowfish_Encrypt.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
