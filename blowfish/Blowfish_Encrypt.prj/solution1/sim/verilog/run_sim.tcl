...
if {[file isfile Blowfish_Encrypt.autotvin.dat]} {
	file delete -force Blowfish_Encrypt.autotvin.dat
}

if {[file isfile Blowfish_Encrypt.autotvout.dat]} {
	file delete -force Blowfish_Encrypt.autotvout.dat
}
