...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.Blowfish_Encrypt.autotvin_plaintext.dat"
         "c.Blowfish_Encrypt.autotvin_ciphertext.dat"
         "c.Blowfish_Encrypt.autotvin_P.dat"
         "c.Blowfish_Encrypt.autotvin_S.dat"
         "c.Blowfish_Encrypt.autotvout_ciphertext.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.Blowfish_Encrypt.autotvout_ciphertext.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
