...
int main() {
    ...
    const unsigned char plaintext[] = "Tsisssssssssssssssssssss?";
    ...
    blowfish.Encrypt(encrypted, plaintext, sizeof(plaintext));

    // Decrypt the encrypted text
    blowfish.Decrypt(decrypted, encrypted, sizeof(plaintext));
