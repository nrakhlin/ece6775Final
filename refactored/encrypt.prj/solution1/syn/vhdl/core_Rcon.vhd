...
architecture rtl of core_Rcon_rom is 
...
architecture arch of core_Rcon is
    component core_Rcon_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    core_Rcon_rom_U :  component core_Rcon_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
