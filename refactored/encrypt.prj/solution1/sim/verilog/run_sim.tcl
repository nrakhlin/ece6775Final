...
if {[file isfile encrypt_dut.autotvin.dat]} {
	file delete -force encrypt_dut.autotvin.dat
}

if {[file isfile encrypt_dut.autotvout.dat]} {
	file delete -force encrypt_dut.autotvout.dat
}
