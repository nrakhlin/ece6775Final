...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.encrypt_dut.autotvin_input_r.dat"
         "c.encrypt_dut.autotvin_output_r.dat"
         "c.encrypt_dut.autotvin_key.dat"
         "c.encrypt_dut.autotvout_output_r.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.encrypt_dut.autotvout_output_r.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
