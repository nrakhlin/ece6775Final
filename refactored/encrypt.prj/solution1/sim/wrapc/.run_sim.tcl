...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "encrypt_dut.autotvin.dat"
	set constFileTvOut       "encrypt_dut.autotvout.dat"
	set constFileHdlTvIn     "encrypt_dut.autohdltvin.dat"
	set constFileHdlTvOut    "encrypt_dut.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
