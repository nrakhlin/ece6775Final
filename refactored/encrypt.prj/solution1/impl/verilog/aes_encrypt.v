...
wire   [3:0] zext_ln46_fu_150_p1;
reg   [3:0] zext_ln46_reg_300;
wire    ap_CS_fsm_state2;
wire   [2:0] i_fu_160_p2;
reg   [2:0] i_reg_308;
wire   [3:0] shl_ln_fu_170_p3;
reg   [3:0] shl_ln_reg_313;
wire   [0:0] icmp_ln46_fu_154_p2;
wire   [2:0] j_fu_188_p2;
reg   [2:0] j_reg_321;
wire    ap_CS_fsm_state3;
wire   [0:0] icmp_ln49_fu_182_p2;
wire   [3:0] add_ln51_1_fu_216_p2;
reg   [3:0] add_ln51_1_reg_331;
...
wire   [3:0] add_ln67_1_fu_291_p2;
reg   [3:0] add_ln67_1_reg_367;
...
wire   [63:0] zext_ln51_1_fu_221_p1;
wire   [63:0] zext_ln67_fu_286_p1;
wire   [63:0] zext_ln67_1_fu_296_p1;
wire   [1:0] trunc_ln51_fu_166_p1;
wire   [3:0] zext_ln49_fu_178_p1;
wire   [3:0] add_ln51_fu_194_p2;
wire   [1:0] trunc_ln51_1_fu_204_p1;
wire   [3:0] shl_ln51_1_fu_208_p3;
wire   [1:0] trunc_ln67_fu_241_p1;
wire   [1:0] trunc_ln67_1_fu_269_p1;
wire   [3:0] shl_ln67_1_fu_273_p3;
wire   [3:0] add_ln67_fu_281_p2;
wire   [3:0] zext_ln65_fu_253_p1;
reg   [9:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((icmp_ln46_fu_154_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln49_fu_182_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln46_fu_154_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        j_0_reg_98 <= 3'd0;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln62_fu_229_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state8))) begin
        j_1_reg_120 <= 3'd0;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln49_fu_182_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        add_ln51_1_reg_331 <= add_ln51_1_fu_216_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln65_fu_257_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state9))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        ...
        zext_ln46_reg_300[2 : 0] <= zext_ln46_fu_150_p1[2 : 0];
    end
end
...
always @ (*) begin
    if ((((icmp_ln62_fu_229_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state8)) | ((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((icmp_ln62_fu_229_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state8))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        block_address0 = zext_ln67_fu_286_p1;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
        block_address0 = zext_ln51_1_fu_221_p1;
...
assign add_ln51_1_fu_216_p2 = (shl_ln51_1_fu_208_p3 + zext_ln46_reg_300);

assign add_ln51_fu_194_p2 = (zext_ln49_fu_178_p1 + shl_ln_reg_313);

assign add_ln67_1_fu_291_p2 = (zext_ln65_fu_253_p1 + shl_ln2_reg_349);

assign add_ln67_fu_281_p2 = (shl_ln67_1_fu_273_p3 + zext_ln62_reg_336);
...
assign icmp_ln46_fu_154_p2 = ((i_0_reg_87 == 3'd4) ? 1'b1 : 1'b0);

assign icmp_ln49_fu_182_p2 = ((j_0_reg_98 == 3'd4) ? 1'b1 : 1'b0);

assign icmp_ln62_fu_229_p2 = ((i_1_reg_109 == 3'd4) ? 1'b1 : 1'b0);

assign icmp_ln65_fu_257_p2 = ((j_1_reg_120 == 3'd4) ? 1'b1 : 1'b0);

assign input_r_address0 = zext_ln51_fu_199_p1;
...
assign output_r_address0 = zext_ln67_1_fu_296_p1;

assign output_r_d0 = block_q0;

assign shl_ln2_fu_245_p3 = {{trunc_ln67_fu_241_p1}, {2'd0}};

assign shl_ln51_1_fu_208_p3 = {{trunc_ln51_1_fu_204_p1}, {2'd0}};

assign shl_ln67_1_fu_273_p3 = {{trunc_ln67_1_fu_269_p1}, {2'd0}};

assign shl_ln_fu_170_p3 = {{trunc_ln51_fu_166_p1}, {2'd0}};

assign trunc_ln51_1_fu_204_p1 = j_0_reg_98[1:0];

assign trunc_ln51_fu_166_p1 = i_0_reg_87[1:0];

assign trunc_ln67_1_fu_269_p1 = j_1_reg_120[1:0];

assign trunc_ln67_fu_241_p1 = i_1_reg_109[1:0];

assign zext_ln46_fu_150_p1 = i_0_reg_87;

assign zext_ln49_fu_178_p1 = j_0_reg_98;

assign zext_ln51_1_fu_221_p1 = add_ln51_1_reg_331;

assign zext_ln51_fu_199_p1 = add_ln51_fu_194_p2;

assign zext_ln62_fu_225_p1 = i_1_reg_109;

assign zext_ln65_fu_253_p1 = j_1_reg_120;

assign zext_ln67_1_fu_296_p1 = add_ln67_1_reg_367;

assign zext_ln67_fu_286_p1 = add_ln67_fu_281_p2;

always @ (posedge ap_clk) begin
    zext_ln46_reg_300[3] <= 1'b0;
    shl_ln_reg_313[1:0] <= 2'b00;
    zext_ln62_reg_336[3] <= 1'b0;
