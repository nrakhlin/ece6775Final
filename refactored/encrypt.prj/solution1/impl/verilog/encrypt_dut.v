...
wire    grp_aes_encrypt_fu_146_ap_start;
wire    grp_aes_encrypt_fu_146_ap_done;
wire    grp_aes_encrypt_fu_146_ap_idle;
wire    grp_aes_encrypt_fu_146_ap_ready;
wire   [3:0] grp_aes_encrypt_fu_146_output_r_address0;
wire    grp_aes_encrypt_fu_146_output_r_ce0;
wire    grp_aes_encrypt_fu_146_output_r_we0;
wire   [7:0] grp_aes_encrypt_fu_146_output_r_d0;
wire   [3:0] grp_aes_encrypt_fu_146_key_address0;
wire    grp_aes_encrypt_fu_146_key_ce0;
reg    grp_aes_encrypt_fu_146_ap_start_reg;
...
initial begin
#0 ap_CS_fsm = 2'd1;
#0 grp_aes_encrypt_fu_146_ap_start_reg = 1'b0;
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_aes_encrypt_fu_146_ap_start_reg <= 1'b0;
    end else begin
        if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
            grp_aes_encrypt_fu_146_ap_start_reg <= 1'b1;
        end else if ((grp_aes_encrypt_fu_146_ap_ready == 1'b1)) begin
            grp_aes_encrypt_fu_146_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (*) begin
    if (((grp_aes_encrypt_fu_146_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
assign grp_aes_encrypt_fu_146_ap_start = grp_aes_encrypt_fu_146_ap_start_reg;

assign key_address0 = grp_aes_encrypt_fu_146_key_address0;

assign key_ce0 = grp_aes_encrypt_fu_146_key_ce0;

assign output_r_address0 = grp_aes_encrypt_fu_146_output_r_address0;

assign output_r_ce0 = grp_aes_encrypt_fu_146_output_r_ce0;

assign output_r_d0 = grp_aes_encrypt_fu_146_output_r_d0;

assign output_r_we0 = grp_aes_encrypt_fu_146_output_r_we0;
