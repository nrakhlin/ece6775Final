...
`define AUTOTB_DUT      encrypt_dut
`define AUTOTB_DUT_INST AESL_inst_encrypt_dut
`define AUTOTB_TOP      apatb_encrypt_dut_top
`define AUTOTB_LAT_RESULT_FILE "encrypt_dut.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "encrypt_dut.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_encrypt_dut_top
...
`define AUTOTB_TVIN_input_r  "./c.encrypt_dut.autotvin_input_r.dat"
`define AUTOTB_TVIN_output_r  "./c.encrypt_dut.autotvin_output_r.dat"
`define AUTOTB_TVIN_key  "./c.encrypt_dut.autotvin_key.dat"
`define AUTOTB_TVIN_input_r_out_wrapc  "./rtl.encrypt_dut.autotvin_input_r.dat"
`define AUTOTB_TVIN_output_r_out_wrapc  "./rtl.encrypt_dut.autotvin_output_r.dat"
`define AUTOTB_TVIN_key_out_wrapc  "./rtl.encrypt_dut.autotvin_key.dat"
`define AUTOTB_TVOUT_output_r  "./c.encrypt_dut.autotvout_output_r.dat"
`define AUTOTB_TVOUT_output_r_out_wrapc  "./impl_rtl.encrypt_dut.autotvout_output_r.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 4484;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.encrypt_dut.autotvout_output_r.dat", "r");
    fp2 = $fopen("./impl_rtl.encrypt_dut.autotvout_output_r.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.encrypt_dut.autotvout_output_r.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.encrypt_dut.autotvout_output_r.dat\"!");
    else begin
        $display("Comparing rtl.encrypt_dut.autotvout_output_r.dat with impl_rtl.encrypt_dut.autotvout_output_r.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
