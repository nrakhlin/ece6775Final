...
set C_modelArgList {
	{ expandedKey int 8 regular {array 176 { 2 2 } 1 1 }  }
...
set portList { 
	...
	{ expandedKey_d1 sc_out sc_lv 8 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "expandedKey_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "expandedKey", "role": "d1" }} , 
...
set Spec2ImplPortList { 
	expandedKey { ap_memory {  { expandedKey_address0 mem_address 1 8 }  { expandedKey_ce0 mem_ce 1 1 }  { expandedKey_we0 mem_we 1 1 }  { expandedKey_d0 mem_din 1 8 }  { expandedKey_q0 mem_dout 0 8 }  { expandedKey_address1 MemPortADDR2 1 8 }  { expandedKey_ce1 MemPortCE2 1 1 }  { expandedKey_we1 MemPortWE2 1 1 }  { expandedKey_d1 MemPortDIN2 1 8 }  { expandedKey_q1 MemPortDOUT2 0 8 } } }
