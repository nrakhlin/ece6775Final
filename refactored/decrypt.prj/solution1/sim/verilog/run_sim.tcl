...
if {[file isfile decrypt_dut.autotvin.dat]} {
	file delete -force decrypt_dut.autotvin.dat
}

if {[file isfile decrypt_dut.autotvout.dat]} {
	file delete -force decrypt_dut.autotvout.dat
}
