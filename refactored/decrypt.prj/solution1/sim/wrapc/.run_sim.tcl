...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "decrypt_dut.autotvin.dat"
	set constFileTvOut       "decrypt_dut.autotvout.dat"
	set constFileHdlTvIn     "decrypt_dut.autohdltvin.dat"
	set constFileHdlTvOut    "decrypt_dut.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
